...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('checkout', '0002_auto_20180414_1902'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_option', models.CharField(choices=[('pagaseguro', 'PagSeguro'), ('paypal', 'Paypal')], max_length=20, verbose_name='Opções de Pagamento')),
